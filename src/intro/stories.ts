...
export const STORIES: Record<string, Story> = {
  arcade: {
    ...
    title: 'PAPA PANIC',
    beats: [
      { seconds: 4.4, scene: 'workshop', voice: 'narrator', line: 'Down in the workshop, {papa} has been busy again.' },
      { seconds: 5.9, scene: 'workshop', voice: 'papa', line: 'Four of them! Four little machines, and every one of them wants YOU.' },
      ...
      { seconds: 5.9, scene: 'workshopDoor', voice: 'narrator', line: 'Caught? The maths door opens. Two minutes of sums buys you another go.' },
      { seconds: 3.4, scene: 'title', voice: 'papa', line: 'Off you go. I will be watching.' },
    ],
  },
  ...
  dave: {
    ...
    beats: [
      ...
      { seconds: 4.4, scene: 'workshop', voice: 'papa', line: 'Fire! Water! A jetpack I have NOT tested! Enjoy!' },
      ...
      { seconds: 6.3, scene: 'workshopDoor', voice: 'narrator', line: 'Every cave can be finished. A machine checked them all before you got here.' },
      { seconds: 4.4, scene: 'title', voice: 'papa', line: 'Mind the spikes. Or do not. Up to you.' },
    ],
  },
  ...
  prince: {
    ...
    beats: [
      ...
      { seconds: 5.5, scene: 'workshop', voice: 'papa', line: 'One hour! For all thirteen! I timed it myself and I laughed.' },
      ...
      { seconds: 3.4, scene: 'title', voice: 'papa', line: 'Fifty-nine minutes. Fifty-eight. Oh dear.' },
    ],
  },
  ...
  pipes: {
    ...
    beats: [
      ...
      { seconds: 6.3, scene: 'workshop', voice: 'papa', line: 'They only walk forwards! That is the beauty of it! No brains at all!' },
      ...
      { seconds: 5.1, scene: 'title', voice: 'papa', line: 'The flag is at the far end. Good luck getting there.' },
    ],
  },
}
