...
export const LEVELS: readonly Level[] = [
  {
    ...
    rows: [
      "                                                                                                    ",
      "       3     3     3     3     33    3     3     3     3     33          3     3     3     33       ",
      "                33            ####                          ####   3 T3     33            ####      ",
      "      33       ####                           33 3                 ######  ####                     ",
      "     ####            33          33          #####                               33                 ",
      "                    ####        ####    3333                   44     3333      ####                ",
  ...
  },
  {
    ...
    rows: [
      "                                                                                                    ",
      "                                                       3333                          3333           ",
      "       3  3333     3     3  3333     3  3333     3     ####  3  T  3  3333     3     ####           ",
      "          ####              #####       ####        3333       #####  ####              55 3        ",
      "                33                            33    #####                              #####        ",
      "          33 3 ####   33 3          33       ####                 33     3443                       ",
      "         #####        ####         ####       33 3               ####   #####    33                 ",
      "                                             #####                              ####        6       ",
      "   3                                                                                      D         ",
      "#######################^^######^^##############^^####################^^#########^^##################",
  ...
  },
  {
    ...
    rows: [
      "                                                                                                    ",
      "    !     !    !       !   !   !   !         !       !         !    !     !           !       !     ",
      "       3           3 33  3           3           3 33  3     3     3T 3  3     3 33  3     3        ",
      "          3333      ####    3333        3333      ####            ######        ####                ",
      "          ####              #####       ####  33    3333                                66 3        ",
      "         G3     33                           ####   ####       44           33         #####        ",
      "        #####  ####            33                             #####        ####                     ",
  ...
  },
  {
    ...
    rows: [
      "                                                                                                    ",
      "             3     3 33  3     3           3 !   3  !  3     3     3 T3  3     3 33  3              ",
      "      33            ####            33                             ######       ####    3663        ",
      "     ####                          ####                3333                             #####       ",
      "                            3333        3333       44  ####        3553                             ",
      "         G3                 #####       ####      #####      33    #####                            ",
